...
<div class="form-group col-xs-2">
  ...
  <button class="form-control" id="gens">Generate</button>
</div>
 </div></div></div></div>
<div id="content">
...
<table class="table">
  ...
  <tr>
    ...
    <td>
      <strong><h4>SPECIAL SAVINGS MONTHLY REPORT</h4></strong>
    </td>
  </tr>
  </thead>
  <tr>
    ...
    <td><?php echo thrift_special_mnt(2)[0]; ?></td>
  </tr>
  <tr>
    <th>
      Total Amount Deposited
    </th>
    <td><?php echo thrift_special_mnt(2)[1]; ?></td>
  </tr>
  <tr>
    <th>
      Total Number of Accounts Opened
    </th>
    <td><?php echo thrift_special_mnt(2)[2]; ?></td>
  </tr>
